...
<!--[if !IE]><!--><html class="ng-csp"><!--<![endif]-->
	...
	<head data-user="<?php p($_['user_uid']); ?>" data-requesttoken="<?php p($_['requesttoken']); ?>">
		...
		<link media="screen" type="text/css" href="<?php print_unescaped($themepath.'/core/css/cssmenu.css') ?>" rel="stylesheet">
	...
	<header><div id="header">
			...
			<a href="<?php print_unescaped(link_to('', 'index.php')); ?>" title="" id="owncloud"><img class="svg logfrontend"
				src="<?php print_unescaped($themepath.'/core/img/logo_frontend.png'); ?>" alt="<?php p($theme->getName()); ?>" /></a>
			<div id="logo-claim" style="display:none;"><?php p($theme->getLogoClaim()); ?></div>
			<!-- Menu -->
			<div id='cssmenu'>
			<ul>
			   <li class=''><a href='index.html'><span>Portail Client</span></a></li>
			   <li><a href='#'><span>VMPath.net</span></a></li>
